 ...
 */
class getFavoritRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FavoritRepository' shared autowired service.
     *
     * @return \App\Repository\FavoritRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FavoritRepository.php';

        return $container->privates['App\\Repository\\FavoritRepository'] = new \App\Repository\FavoritRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
