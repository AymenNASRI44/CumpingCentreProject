...
class __TwigTemplate_cb3fbf4d9be3a69038f872c18b9d92d6f2b4906bb315e9041c88d85616c51cdf extends Template
{
...
";
    ...
    public function block_ea_fileupload_widget(array $context, array $blocks = []): iterable
    {
        ...
        yield "
                ";
        // line 750
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 750, $this->source); })()), "file", [], "any", false, false, false, 750), 'label', ["label_attr" => ["class" => "custom-file-label"]] + (twig_test_empty($_label_ = (isset($context["placeholder"]) || array_key_exists("placeholder", $context) ? $context["placeholder"] : (function () { throw new RuntimeError('Variable "placeholder" does not exist.', 750, $this->source); })())) ? [] : ["label" => $_label_]));
        yield "
            </div>
...
{% endblock %}
", "@EasyAdmin/crud/form_theme.html.twig", "C:\\xampp\\htdocs\\projetC\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\crud\\form_theme.html.twig");
    }
}
