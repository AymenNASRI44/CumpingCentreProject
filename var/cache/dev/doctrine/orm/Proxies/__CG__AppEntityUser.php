...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'App\\Entity\\User' . "\0" . 'avis', '' . "\0" . 'App\\Entity\\User' . "\0" . 'favorits', '' . "\0" . 'App\\Entity\\User' . "\0" . 'reservations', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id_region'];
        }
     ...
     * {@inheritDoc}
     */
    public function getIdRegion(): ?\App\Entity\Region
    {
     ...
     * {@inheritDoc}
     */
    public function setIdRegion(?\App\Entity\Region $id_region): static
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdRegion', [$id_region]);

        return parent::setIdRegion($id_region);
    }
